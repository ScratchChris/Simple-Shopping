//
//  PreviousShopItemsViewController.swift
//  Simple Shopping
//
...
class PreviousShopItemsViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        listBrain.loadPreviousShopItems(vc: self)
        tableView.reloadData()
        print("listBrain.fetchedItemsController")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "previousShopItem", for: indexPath)
